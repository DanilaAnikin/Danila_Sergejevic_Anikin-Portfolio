    ...
    <section className="hero-section" id="profile">
      <div className="hero-copy">
        ...
        <div className="hero-actions">
          ...
          <a className="button-secondary" href="/cv/danila-anikin-cv.pdf?v=3">
            {copy.secondaryCta}
            <FileDown size={17} />
          </a>
        </div>
    ...
    <div className="web-directory">
      ...
      <div className="directory-links">
        {["AI.htm", "LINUX.htm", "PROJECTS.htm", "CV.pdf"].map((item) => (
          <a href={item === "CV.pdf" ? "/cv/danila-anikin-cv.pdf?v=3" : "#lab"} key={item}>
            {item}
          </a>
        ))}
      </div>
      ...
      <div className="win-one-window">
        ...
        <div className="win-one-icons">
          {["AI", "DEV", "LIN", "CV"].map((item) => (
            <a href={item === "CV" ? "/cv/danila-anikin-cv.pdf?v=3" : "#lab"} key={item}>
              <FileText size={20} />
              {item}
            </a>
          ))}
