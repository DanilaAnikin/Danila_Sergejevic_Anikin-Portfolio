...
export const translations = {
  en: {
    ...
    cvNote: "Place the PDF at public/cv/danila-anikin-cv.pdf.",
  ...
  cs: {
    ...
    cvNote: "PDF vlož do public/cv/danila-anikin-cv.pdf.",
  ...
  ru: {
    ...
    cvNote: "Положи PDF в public/cv/danila-anikin-cv.pdf.",
  ...
  de: {
    ...
    cvNote: "Lege das PDF unter public/cv/danila-anikin-cv.pdf ab.",
  ...
  es: {
    ...
    cvNote: "Coloca el PDF en public/cv/danila-anikin-cv.pdf.",
  ...
  fr: {
    ...
    cvNote: "Place le PDF dans public/cv/danila-anikin-cv.pdf.",
